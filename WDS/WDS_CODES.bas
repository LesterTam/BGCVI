...
Case "A"
    LABEL1_STR = "&mode=annual_reports"
    LABEL2_STR = "start_date"
Case "Q"
    LABEL1_STR = "&mode=quarterly_reports"
...
URL_STR = "http://" & SERVER_STR & PUB_ADVFN_URL_STR '& "&btn="
URL_STR = URL_STR & "&symbol=" & TICKER_STR & LABEL1_STR
